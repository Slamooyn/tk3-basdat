...
CREATE SEQUENCE member_nomor_seq START 1;

CREATE TABLE member (
    email VARCHAR(100) PRIMARY KEY,
    nomor_member VARCHAR(20) NOT NULL UNIQUE DEFAULT 'M' || LPAD(NEXTVAL('member_nomor_seq')::TEXT, 4, '0'),
...
('budi.santoso@gmail.com',      '2021-03-10', 'TIER-BLU',  3200,   5800),
('siti.rahayu@gmail.com',       '2021-05-22', 'TIER-BLU',  1500,   2300),
('ahmad.fauzi@yahoo.com',       '2022-01-15', 'TIER-BLU',  4800,   7200),
('dewi.lestari@gmail.com',      '2022-04-03', 'TIER-BLU',   900,   1500),
('rina.marlina@gmail.com',      '2022-07-19', 'TIER-BLU',  2700,   4100),
('nurhasanah@gmail.com',        '2023-02-28', 'TIER-BLU',   500,    800),
('indah.permata@gmail.com',     '2023-05-11', 'TIER-BLU',  1200,   1900),
('sukmawati@gmail.com',         '2023-06-30', 'TIER-BLU',  3500,   5200),
('fitri.handayani@gmail.com',   '2023-08-14', 'TIER-BLU',  2100,   3400),
('ayu.maharani@gmail.com',      '2023-09-05', 'TIER-BLU',   750,   1100),
('kevin.tan@gmail.com',         '2021-11-20', 'TIER-BLU',  4200,   6700),
('lisa.wong@gmail.com',         '2022-03-08', 'TIER-BLU',  3100,   4900),
('lina.oktavia@gmail.com',      '2023-01-17', 'TIER-BLU',  1800,   2600),
('tiara.anggraini@gmail.com',   '2023-10-01', 'TIER-BLU',   300,    500),
('nadia.safitri@gmail.com',     '2024-01-09', 'TIER-BLU',   100,    200),
('samuel.tan@gmail.com',        '2024-02-14', 'TIER-BLU',   450,    700),
('clara.wijaya@gmail.com',      '2024-03-22', 'TIER-BLU',   600,   1000),
('laras.setiawati@gmail.com',   '2024-04-10', 'TIER-BLU',   200,    350),
('rara.ayu@gmail.com',          '2024-05-18', 'TIER-BLU',   800,   1300),
('michiko.tanaka@gmail.com',    '2024-06-25', 'TIER-BLU',   150,    250),
('dr.hendra@gmail.com',         '2020-09-12', 'TIER-SLV', 18500,  32000),
('bambang.irawan@gmail.com',    '2020-11-04', 'TIER-SLV', 22000,  38500),
('andre.setiawan@gmail.com',    '2021-02-17', 'TIER-SLV', 16800,  28000),
('rudi.hartono@gmail.com',      '2021-04-29', 'TIER-SLV', 25000,  37000),
('eko.prasetyo@gmail.com',      '2021-07-06', 'TIER-SLV', 19200,  30500),
('galih.saputra@gmail.com',     '2021-08-23', 'TIER-SLV', 21000,  35000),
('agus.kurniawan@gmail.com',    '2022-01-31', 'TIER-SLV', 17500,  27000),
('fajar.ramadhan@gmail.com',    '2022-05-14', 'TIER-SLV', 23500,  39000),
('irfan.hakim@gmail.com',       '2022-09-27', 'TIER-SLV', 15500,  26000),
('bagas.nugroho@gmail.com',     '2022-12-05', 'TIER-SLV', 20000,  33000),
('tony.nguyen@gmail.com',       '2021-06-18', 'TIER-SLV', 16000,  25500),
('sophia.chen@gmail.com',       '2021-10-09', 'TIER-SLV', 24000,  38000),
('haris.maulana@gmail.com',     '2022-02-20', 'TIER-SLV', 18000,  29000),
('teguh.wibowo@gmail.com',      '2020-08-15', 'TIER-SLV', 26000,  39500),
('rizky.firmansyah@gmail.com',  '2023-03-12', 'TIER-SLV', 15200,  25000),
('dr.maya@yahoo.com',           '2019-04-08', 'TIER-GLD', 52000,  85000),
('yusuf.pratama@gmail.com',     '2019-07-21', 'TIER-GLD', 48000,  76000),
('maria.susanti@gmail.com',     '2019-10-14', 'TIER-GLD', 61000,  92000),
('dr.wahyu@gmail.com',          '2018-12-03', 'TIER-GLD', 55000,  88000),
('dodi.hermawan@gmail.com',     '2019-03-27', 'TIER-GLD', 43000,  71000),
('ratna.dewi@gmail.com',        '2020-02-11', 'TIER-GLD', 57000,  90000),
('faisal.rahman@gmail.com',     '2020-05-30', 'TIER-GLD', 41500,  68000),
('daniel.park@gmail.com',       '2019-11-19', 'TIER-GLD', 63000,  95000),
('endang.susilowati@gmail.com', '2018-07-07', 'TIER-GLD', 49000,  79000),
('winda.puspita@gmail.com',     '2020-09-24', 'TIER-GLD', 44500,  72000),
('dr.anita@yahoo.com',          '2017-06-15', 'TIER-PLT', 125000, 210000),
('sri.mulyani@gmail.com',       '2016-03-20', 'TIER-PLT', 98000,  175000),
('dr.baskoro@gmail.com',        '2015-11-08', 'TIER-PLT', 145000, 250000),
('dr.sinta@gmail.com',          '2016-09-30', 'TIER-PLT', 112000, 195000),
('dr.arief@gmail.com',          '2017-04-12', 'TIER-PLT', 89000,  160000);
